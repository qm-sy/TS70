...
void PWM_Init( void )
{
    ...
    PWMB_CCER1 = 0x11;           //配置通道PWM5  PWM6输出使能和极性 
    PWMB_CCER2 = 0x01;           //配置通道PWM7输出使能和极性 

    PWMB_ARR   = 0x0450;        //设置自动重装载寄存器值:1104 
                 
    PWMB_PSCR  = 0x0031;        //设置频率   频率越大 波形越平滑  11059200/(PWMB_PSCR+1)(PWMB_ARR+1)  200hz

    PWMB_CCR5  = 0x012C;        //设置PWM7占空比
    PWMB_CCR6  = 0x012C;        //设置PWM7占空比
    PWMB_CCR7  = 0x012C;        //设置PWM7占空比

    //PWMB_ENO  |= 0x15;          //使能 PWM5 & PWM6 & PWM7 输出

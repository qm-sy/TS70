...
void temp_scan( void )
{
    ...
    {
        temp.F_temp_val =  get_temp(NTC_1);
        temp.M_temp_val =  get_temp(NTC_2);
        temp.R_temp_val =  get_temp(NTC_3);

        Read_DHT11();

        if( temp.F_temp_val < slave_06.F_alarm_val )
        {
            AC_Out1 = (slave_06.F_switch == 1) ? AC_ON : AC_OFF;
        ...
        if( temp.M_temp_val < slave_06.M_alarm_val )
        {
            AC_Out2 = (slave_06.M_switch == 1) ? AC_ON : AC_OFF;
        ...
        if( temp.R_temp_val < slave_06.R_alarm_val )
        {
            AC_Out3 = (slave_06.R_switch == 1) ? AC_ON : AC_OFF;
